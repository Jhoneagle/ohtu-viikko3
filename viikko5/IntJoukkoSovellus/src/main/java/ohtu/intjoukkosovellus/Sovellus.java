...
public class Sovellus {
    ...
    private static void yhdiste() {
        ...
        bJoukko = mikaJoukko();
        c = IntJoukko.joukkoOperaatiot(aJoukko, bJoukko, "yhdiste");
    ...
    private static void leikkaus() {
        ...
        System.out.print("2. joukko? ");
        bJoukko = mikaJoukko();
        c = IntJoukko.joukkoOperaatiot(aJoukko, bJoukko, "leikkaus");
    ...
    private static void erotus() {
        ...
        System.out.print("2. joukko? ");
        bJoukko = mikaJoukko();
        c = IntJoukko.joukkoOperaatiot(aJoukko, bJoukko, "erotus");
